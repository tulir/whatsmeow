...
type Armadillo_Signal_EncryptedBackupsSecrets_Epoch struct {
	...
	Status  Armadillo_Signal_EncryptedBackupsSecrets_Epoch_EpochStatus `protobuf:"varint,4,opt,name=status,proto3,enum=WAArmadilloApplication.Armadillo_Signal_EncryptedBackupsSecrets_Epoch_EpochStatus" json:"status,omitempty"`
}
...
func (x *Armadillo_Signal_EncryptedBackupsSecrets_Epoch) GetStatus() Armadillo_Signal_EncryptedBackupsSecrets_Epoch_EpochStatus {
	...
	return Armadillo_Signal_EncryptedBackupsSecrets_Epoch_EPOCHSTATUS_UNKNOWN
}
...
type Armadillo_Content_PaymentsTransactionMessage struct {
	...
	PaymentStatus          Armadillo_Content_PaymentsTransactionMessage_PaymentStatus `protobuf:"varint,4,opt,name=paymentStatus,proto3,enum=WAArmadilloApplication.Armadillo_Content_PaymentsTransactionMessage_PaymentStatus" json:"paymentStatus,omitempty"`
...
func (x *Armadillo_Content_NoteReplyMessage) GetNoteReplyText() *waCommon.MessageText {
	if x != nil {
		return x.NoteReplyText
	}
	return nil
}
...
type Armadillo_Content_ScreenshotAction struct {
	...
	ScreenshotType Armadillo_Content_ScreenshotAction_ScreenshotType `protobuf:"varint,1,opt,name=screenshotType,proto3,enum=WAArmadilloApplication.Armadillo_Content_ScreenshotAction_ScreenshotType" json:"screenshotType,omitempty"`
}
...
func (x *Armadillo_Content_ScreenshotAction) GetScreenshotType() Armadillo_Content_ScreenshotAction_ScreenshotType {
	...
	return Armadillo_Content_ScreenshotAction_SCREENSHOTTYPE_UNKNOWN
}
...
type Armadillo_Content_RavenActionNotifMessage struct {
	...
	ActionType      Armadillo_Content_RavenActionNotifMessage_ActionType `protobuf:"varint,3,opt,name=actionType,proto3,enum=WAArmadilloApplication.Armadillo_Content_RavenActionNotifMessage_ActionType" json:"actionType,omitempty"`
}
...
type Armadillo_Content_RavenMessage struct {
	...
	EphemeralType Armadillo_Content_RavenMessage_EphemeralType  `protobuf:"varint,1,opt,name=ephemeralType,proto3,enum=WAArmadilloApplication.Armadillo_Content_RavenMessage_EphemeralType" json:"ephemeralType,omitempty"`
}
...
type Armadillo_Content_CommonSticker struct {
	...
	StickerType Armadillo_Content_CommonSticker_StickerType `protobuf:"varint,1,opt,name=stickerType,proto3,enum=WAArmadilloApplication.Armadillo_Content_CommonSticker_StickerType" json:"stickerType,omitempty"`
}
...
func (x *Armadillo_Content_CommonSticker) GetStickerType() Armadillo_Content_CommonSticker_StickerType {
	...
	return Armadillo_Content_CommonSticker_STICKERTYPE_UNKNOWN
}
...
var file_waArmadilloApplication_WAArmadilloApplication_proto_depIdxs = []int32{
	...
	38, // 37: WAArmadilloApplication.Armadillo.Content.NoteReplyMessage.noteText:type_name -> WACommon.MessageText
	38, // 38: WAArmadilloApplication.Armadillo.Content.NoteReplyMessage.noteReplyText:type_name -> WACommon.MessageText
	37, // 39: WAArmadilloApplication.Armadillo.Content.BumpExistingMessage.key:type_name -> WACommon.MessageKey
	39, // 40: WAArmadilloApplication.Armadillo.Content.ImageGalleryMessage.images:type_name -> WACommon.SubProtocol
	2,  // 41: WAArmadilloApplication.Armadillo.Content.ScreenshotAction.screenshotType:type_name -> WAArmadilloApplication.Armadillo.Content.ScreenshotAction.ScreenshotType
	39, // 42: WAArmadilloApplication.Armadillo.Content.ExtendedContentMessageWithSear.searAssociatedMessage:type_name -> WACommon.SubProtocol
	37, // 43: WAArmadilloApplication.Armadillo.Content.RavenActionNotifMessage.key:type_name -> WACommon.MessageKey
	3,  // 44: WAArmadilloApplication.Armadillo.Content.RavenActionNotifMessage.actionType:type_name -> WAArmadilloApplication.Armadillo.Content.RavenActionNotifMessage.ActionType
	39, // 45: WAArmadilloApplication.Armadillo.Content.RavenMessage.imageMessage:type_name -> WACommon.SubProtocol
	39, // 46: WAArmadilloApplication.Armadillo.Content.RavenMessage.videoMessage:type_name -> WACommon.SubProtocol
	4,  // 47: WAArmadilloApplication.Armadillo.Content.RavenMessage.ephemeralType:type_name -> WAArmadilloApplication.Armadillo.Content.RavenMessage.EphemeralType
	5,  // 48: WAArmadilloApplication.Armadillo.Content.CommonSticker.stickerType:type_name -> WAArmadilloApplication.Armadillo.Content.CommonSticker.StickerType

...
func (a *Postgres) PutManyContactNames() string {
	return `
...
func (a *Postgres) PutChatSetting() string {
	return `
...
func (a *Postgres) PutPrivacyTokens() string {
	return `
...
func (a *Postgres) PlaceholderSyntax() string {
	return "($1, $2, $3, $%d, $%d)"
}

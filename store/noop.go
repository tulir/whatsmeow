...
func (n *NoopStore) MigratePNToLID(pn, lid types.JID) error {
	return n.Error
}
...
func (n *NoopStore) GetMessageSecret(chat, sender types.JID, id types.MessageID) ([]byte, types.JID, error) {
...
func (n *NoopStore) GetBufferedEvent(ciphertextHash [32]byte) (*BufferedEvent, error) {
	return nil, nil
}

func (n *NoopStore) PutBufferedEvent(ciphertextHash [32]byte, plaintext []byte, serverTimestamp time.Time) error {
	return nil
}

func (n *NoopStore) AcceptDevicePairing(user types.JID, deviceID string) error {
	return n.Error
}
...
func (n *NoopStore) ClearBufferedEventPlaintext(ciphertextHash [32]byte) error {
	return nil
}

func (n *NoopStore) DeleteOldBufferedHashes() error {
	return nil
}

func (n *NoopStore) GetLIDForPN(pn types.JID) (types.JID, error) {
	return types.JID{}, n.Error
}

func (n *NoopStore) GetPNForLID(lid types.JID) (types.JID, error) {
	return types.JID{}, n.Error
}

func (n *NoopStore) PutManyLIDMappings(mappings []LIDMapping) error {
	return n.Error
}

func (n *NoopStore) PutLIDMapping(lid types.JID, jid types.JID) error {
	return n.Error
}

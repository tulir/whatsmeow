...
var file_waFingerprint_WAFingerprint_proto_goTypes = []interface{}{
...
func file_waFingerprint_WAFingerprint_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_waFingerprint_WAFingerprint_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_waFingerprint_WAFingerprint_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {

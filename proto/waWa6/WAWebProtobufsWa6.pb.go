...
const (
	ClientPayload_UserAgent_APPSTORE   ClientPayload_UserAgent_DistributionChannel = 0
	ClientPayload_UserAgent_WEBSITE    ClientPayload_UserAgent_DistributionChannel = 1
	ClientPayload_UserAgent_TESTFLIGHT ClientPayload_UserAgent_DistributionChannel = 2
	ClientPayload_UserAgent_INTERNAL   ClientPayload_UserAgent_DistributionChannel = 3
)

// Enum value maps for ClientPayload_UserAgent_DistributionChannel.
var (
	ClientPayload_UserAgent_DistributionChannel_name = map[int32]string{
		0: "APPSTORE",
		1: "WEBSITE",
		2: "TESTFLIGHT",
		3: "INTERNAL",
	}
	ClientPayload_UserAgent_DistributionChannel_value = map[string]int32{
		"APPSTORE":   0,
		"WEBSITE":    1,
		"TESTFLIGHT": 2,
		"INTERNAL":   3,
...
func (x ClientPayload_UserAgent_DistributionChannel) Enum() *ClientPayload_UserAgent_DistributionChannel {
	p := new(ClientPayload_UserAgent_DistributionChannel)
	*p = x
	return p
}

func (x ClientPayload_UserAgent_DistributionChannel) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
// Deprecated: Do not use.
func (x *ClientPayload_UserAgent_DistributionChannel) UnmarshalJSON(b []byte) error {
	num, err := protoimpl.X.UnmarshalJSONEnum(x.Descriptor(), b)
	if err != nil {
		return err
	}
	*x = ClientPayload_UserAgent_DistributionChannel(num)
	return nil
}
...
func (x *ClientPayload) GetTestIsolationID() []byte {
	if x != nil {
...
type ClientPayload_UserAgent struct {
	...
	DistributionChannel         *ClientPayload_UserAgent_DistributionChannel `protobuf:"varint,17,opt,name=distributionChannel,enum=WAWebProtobufsWa6.ClientPayload_UserAgent_DistributionChannel" json:"distributionChannel,omitempty"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
func (x *ClientPayload_UserAgent) GetDistributionChannel() ClientPayload_UserAgent_DistributionChannel {
	if x != nil && x.DistributionChannel != nil {
		return *x.DistributionChannel
	}
	return ClientPayload_UserAgent_APPSTORE
}
...
const file_waWa6_WAWebProtobufsWa6_proto_rawDesc = "" +
	...
	"deviceType\x12(\n" +
	"\x0fdeviceModelType\x18\x10 \x01(\tR\x0fdeviceModelType\x12p\n" +
	"\x13distributionChannel\x18\x11 \x01(\x0e2>.WAWebProtobufsWa6.ClientPayload.UserAgent.DistributionChannelR\x13distributionChannel\x1a\x9a\x01\n" +
	"\n" +
	"AppVersion\x12\x18\n" +
	...
	"\x02VR\x10\x04\"N\n" +
	"\x13DistributionChannel\x12\f\n" +
	"\bAPPSTORE\x10\x00\x12\v\n" +
	"\aWEBSITE\x10\x01\x12\x0e\n" +
	"\n" +
	"TESTFLIGHT\x10\x02\x12\f\n" +
	"\bINTERNAL\x10\x03\"=\n" +

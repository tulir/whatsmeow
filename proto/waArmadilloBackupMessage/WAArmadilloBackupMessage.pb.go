...
func file_waArmadilloBackupMessage_WAArmadilloBackupMessage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_waArmadilloBackupMessage_WAArmadilloBackupMessage_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_waArmadilloBackupMessage_WAArmadilloBackupMessage_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_waArmadilloBackupMessage_WAArmadilloBackupMessage_proto_msgTypes[2].Exporter = func(v any, i int) any {

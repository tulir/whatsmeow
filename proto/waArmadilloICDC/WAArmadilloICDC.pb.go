...
func file_waArmadilloICDC_WAArmadilloICDC_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_waArmadilloICDC_WAArmadilloICDC_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_waArmadilloICDC_WAArmadilloICDC_proto_msgTypes[1].Exporter = func(v any, i int) any {

...
func (x *DeviceCapabilities) GetBizAiSettingsSync() *DeviceCapabilities_BizAiSettingsSync {
	if x != nil {
		return x.BizAiSettingsSync
	}
	return nil
}
...
func (x *DeviceCapabilities_BizAiSettingsSync) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DeviceCapabilities_BizAiSettingsSync) GetHandoffRemovalTimingEnabled() bool {
	if x != nil && x.HandoffRemovalTimingEnabled != nil {
		return *x.HandoffRemovalTimingEnabled
	}
	return false
}
...
func (x *DeviceCapabilities_BusinessBroadcast) GetCompanionSupportEnabled() bool {
	if x != nil && x.CompanionSupportEnabled != nil {
		return *x.CompanionSupportEnabled
	}
	return false
}

func (x *DeviceCapabilities_BusinessBroadcast) GetCampaignSyncEnabled() bool {
	if x != nil && x.CampaignSyncEnabled != nil {
		return *x.CampaignSyncEnabled
	}
	return false
}

func (x *DeviceCapabilities_BusinessBroadcast) GetInsightsSyncEnabled() bool {
	if x != nil && x.InsightsSyncEnabled != nil {
		return *x.InsightsSyncEnabled
	}
	return false
}

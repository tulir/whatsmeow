...
var file_waReporting_WAWebProtobufsReporting_proto_goTypes = []interface{}{
...
func file_waReporting_WAWebProtobufsReporting_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_waReporting_WAWebProtobufsReporting_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_waReporting_WAWebProtobufsReporting_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
		...
		file_waReporting_WAWebProtobufsReporting_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Field); i {
			case 0:
				return &v.state
			case 1:
